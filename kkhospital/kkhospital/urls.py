...
urlpatterns = [
    ...
    # url(r'^payment/visa', app.views.payment, name='payment'),
    ...
    url(r'^staff/collection/(?P<collection_name>\w{0,50})/add/$',
        app.views.admin_mongo_add, name='admin_mongo-add'),
    url(r'^staff/collection/(?P<collection_name>\w{0,50})/edit/(?P<object_id>\w{0,50})$',
        app.views.admin_mongo_edit, name='admin_mongo-edit'),
    url(r'^staff/collection/(?P<collection_name>\w{0,50})/delete/(?P<object_id>\w{0,50})$',
